...
class NLGTestCases(unittest.TestCase):
    ...
    def testJSONToRecipe(self):
        json = {"intent" : "preference", "contents" : {"category" : "food", "content" : "cheeseburger"}, \
                "assertion": True, "tense" : "VB", "descriptor" : {"opinion" : "Actually, Burger King has the best burgers"}}
        recipe = self.nlg_module.JSONToRecipe(json)
